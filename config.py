...
def get_arguments():
    ...
    parser.add_argument("--checkpoints", type=str, default="./all_checkpoints/checkpoints_1")
    ...
    parser.add_argument("--lr_C", type=float, default=1e-2)# 1e-3
    ...
    parser.add_argument("--p_attack", type=float, default=0.01)
